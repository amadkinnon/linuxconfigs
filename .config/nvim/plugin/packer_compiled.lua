...
_G.packer_plugins = {
  ...
  bufexplorer = {
    loaded = true,
    path = "/home/adam/.local/share/nvim/site/pack/packer/start/bufexplorer",
  ...
  ["go.nvim"] = {
    loaded = true,
    path = "/home/adam/.local/share/nvim/site/pack/packer/start/go.nvim",
    url = "https://github.com/ray-x/go.nvim"
  },
  ["guihua.lua"] = {
    loaded = true,
    path = "/home/adam/.local/share/nvim/site/pack/packer/start/guihua.lua",
